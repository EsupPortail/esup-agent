...
import org.esupportail.esupAgent.services.authentication.Authenticator;
...
public class SessionController extends AbstractDomainAwareBean {
	...
	/**
	 * @see org.esupportail.esupAgent.web.controllers.AbstractDomainAwareBean#afterPropertiesSetInternal()
	 */
	@Override
	...
	/**
	 * @return the userLoginUnder
	 */
	public User getUserLoginUnder() {
		return userLoginUnder;
	}

	/**
	 * @param userLoginUnder the userLoginUnder to set
	 */
	public void setUserLoginUnder(User userLoginUnder) {
		this.userLoginUnder = userLoginUnder;
	}
